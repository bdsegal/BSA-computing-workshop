...
If you don't use `~` in front of `variable`, `ggvis` won't know to look in your dataset for `variable`.
...
We'll use the residential energy consumption survey data. As before, we'll ignore the parsing warnings for now (we take a closer look at them in another tutorial).
