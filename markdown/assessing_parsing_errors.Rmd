...
# Assessing parsing errors from `readr`
...
For the rest of the workshop, let's take a look at the electricity consumption data in Kilowatt-hours (KWH). We'll keep those columns, as well as the household id variable `DOEID` and the sampling weights `NWEIGHT`.
