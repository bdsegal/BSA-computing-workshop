...
browseURL(paste("file://",
  file.path(parent, "html", "0.downloading_data.html"), sep = ""))
...
browseURL(paste("file://",
  file.path(parent, "html", "1.managing_large_files.html"), sep = ""))
...
browseURL(paste("file://",
  file.path(parent, "html", "2.assessing_parsing_errors.html"), sep = ""))
...
browseURL(paste("file://",
  file.path(parent, "html", "3.dplyr_data.table.html"), sep = ""))
...
browseURL(paste("file://",
  file.path(parent, "html", "4.split_apply_combine_plot.html"), sep = ""))
...
browseURL(paste("file://",
  file.path(parent, "html", "5.ggvis.html"), sep = ""))
